console.log("Hello from tut10.js")

// FUNCTION AND FUNCTION SCOPES

// function greet(name = 'Hero'){
//     console.log(`Hello ${name}, how are you ?`)
//     return 'returned value can be of any data type';
// }

// greet('Divyansh')
// greet('Rahul')

// let val = greet('shikha')
// console.log(val)

// // It is not necessary to store the returned value from function. like above, we didn't store the return statement in any variable and its fine. But when we did using val, the we can use it.
